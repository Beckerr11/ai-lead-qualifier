const CONTENT = {
  brand: "AI Lead Qualifier",
  strap: "lead intelligence",
  subtitle: "Qualificacao inteligente de leads com score, tier e resumo de acao comercial.",
  accent: "#66e0ff",
  ctaPrimary: "Ver health",
  ctaSecondary: "Explorar API",
  apiTitle: "Core endpoints",
  featuresHtml: `<li><span>01</span><strong>Pontuacao por budget, urgencia e origem para priorizacao comercial.</strong></li><li><span>02</span><strong>Resumo automatico de lead com provider OpenAI opcional e fallback local.</strong></li><li><span>03</span><strong>Pipeline claro para classificar hot, warm e cold sem complexidade desnecessaria.</strong></li>`,
  endpointsHtml: `<li><span class="method">GET</span><span class="path">/health</span></li><li><span class="method">POST</span><span class="path">/leads</span></li><li><span class="method">GET</span><span class="path">/leads</span></li><li><span class="method">GET</span><span class="path">/leads/top</span></li><li><span class="method">POST</span><span class="path">/leads/:id/summarize</span></li>`,
}
